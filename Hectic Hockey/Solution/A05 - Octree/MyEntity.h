...
enum Tags {Wall, Player, Puck, Goal};
...
public:
	...
	*/
	...
	void CollisionResolution(MyEntity* other);
	void PushingCollisionResolution(MyEntity* other);
	void HitGoal(int goalScoredOn);

	/*
	USAGE: Rotates the entity
	ARGUMENTS: The ange to rotate in degrees
	OUTPUT: ---
	*/
	void RotateModel(float a_fAngle, vector3 a_v3axis);
