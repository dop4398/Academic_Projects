...
#pragma region Debugging Information
	...
	//m_pMeshMngr->Print("						");
	m_pMeshMngr->PrintLine("Hectic Hockey", C_YELLOW);
	//m_pMeshMngr->Print("						");
...
#pragma endregion
	...
	if (m_bGUI_Main)
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::TextColored(v4Color, "Jules Apicella");
			ImGui::TextColored(v4Color, "Adam Hall");
			ImGui::TextColored(v4Color, "Alex Herman");
			ImGui::TextColored(v4Color, "David Patch");
			ImGui::Text("FrameRate: %.2f [FPS] -> %.3f [ms/frame]\n",
				ImGui::GetIO().Framerate, 1000.0f / ImGui::GetIO().Framerate);
			//ImGui::Text("Octants: %d\n", m_pRoot->GetOctantCount());
			ImGui::Text("Objects: %d\n", m_uObjects + m_pEntityMngr->GetPlayer1Score() + m_pEntityMngr->GetPlayer2Score());
			ImGui::Separator();
			ImGui::Text("Controls:\n");
			ImGui::Text("   Camera:   WASD");
			ImGui::Text("   Player 1: IJKL");
			ImGui::Text("   Player 2: Arrow keys");
			ImGui::Text("   Toggle bounding spheres: B");
			ImGui::Text("   Toggle grid: G");
			ImGui::Text("   Add 100 Pucks: P");
			ImGui::Text("   Reset the game: R");
			...
			ImGui::Separator();
			ImGui::Text("Score:\n");
			ImGui::Text("   Player 1: %i", m_pEntityMngr->GetPlayer1Score());
			ImGui::Text("   Player 2: %i", m_pEntityMngr->GetPlayer2Score());
			ImGui::Separator();
			...
			ImGui::TextColored(ImColor(255, 255, 0), "Hectic Hockey\n");
		}
		ImGui::End();
	}
