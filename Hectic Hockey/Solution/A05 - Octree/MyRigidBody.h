...
#pragma endregion
	...
	*/
	...
	/*
	USAGE: Checks for collisions between a sphere and rectangle
	ARGUMENTS: MyRigidBody* const a_pOther -> rectangle rigid body to test against
	OUTPUT: True means colliding, false means not
	*/
	bool CheckRectSphereCollision(MyRigidBody* const a_pOther);
	bool xHit = false;
	bool yHit = false;
	bool zHit = false;
	void DefineHits(MyRigidBody* const a_pOther, bool spheres);
...
private:
	...
	*/
	...
	/*
	USAGE: Checks for collisions between two spheres
	ARGUMENTS: MyRigidBody* const a_pOther -> other rigid body to test against
	OUTPUT: True means colliding, false means not
	*/
	bool CheckSphereCollision(MyRigidBody* const a_pOther);
};//class
